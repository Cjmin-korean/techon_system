...
module.exports = function (app) {
    ...
    // **** start       
    sql.connect(config).then(pool => {
        app.post('/api/purwaitmaterial', function (req, res) {
            res.header("Access-Control-Allow-Origin", "*");
    ...
    sql.connect(config).then(pool => {
        app.post('/api/selectconfigip', function (req, res) {
            ...
            return pool.request()
                ...
                .query(
                    'select * from configip order by inputdate,inputtime asc'
                )
                .then(result => {
    ...
    // **** start  생산설비창 띄우기  
    sql.connect(config).then(pool => {
        app.post('/api/selectsamplevina', function (req, res) {
            res.header("Access-Control-Allow-Origin", "*");
            ...
            return pool.request()
                ...
                .query(
                    " select count(*) as datacount from sampleordervina")
    ...
    sql.connect(config).then(pool => {
        app.post('/api/selectcustomerinfovina', function (req, res) {
            res.header("Access-Control-Allow-Origin", "*");
    ...
    // **** start       
    sql.connect(config).then(pool => {
        app.post('/api/selectwonvina', function (req, res) {
            res.header("Access-Control-Allow-Origin", "*");
...
sql.connect(config).then(pool => {
    ...
    // **** start       
    sql.connect(config).then(pool => {
        app.post('/api/updatebomstatusvina', function (req, res) {
            ...
            return pool.request()
                ...
                .query(
                    'update bommanagementvina set status=@status where bomid=@bomid'
                )
                .then(result => {
